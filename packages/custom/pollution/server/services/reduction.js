...
exports.reduction = function(cb) {
    ...
    //my_cb is a callback that must accept another callback as input, and call it (see function generated by db_status_fun for example)
    ...
    async.series([
        ...
        function(callback) {
            ...
            for (var i = 0; i < keyarray.length; i +=1 ) {
                ...
                all_db_jobs.push(async_series_fun(db_jobs,db_status_fun(keyarray[i].key,i)));
