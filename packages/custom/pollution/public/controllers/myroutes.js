...
angular.module('mean.pollution').controller('MyRoutesCtrl', ['$scope', '$stateParams', '$location', 'Global', 'MyRoutes','$state',
  function($scope, $stateParams, $location, Global, MyRoutes, $state) {
    $scope.global = Global;
    ...
    $scope.findOne = function() {
      ...
      MyRoutes.get({
        ...
        gmapPoints = [];
        for(var i=0;i<myroute.points.coordinates.length;i++){
